...
import pro2e.teamX.matlabfunctions.TestVektoren;
import pro2e.teamX.model.Model;

public class SchrittantwortPlot extends JPanel implements Observer {
	private JFreeChart chart = ChartFactory.createXYLineChart("", "Zeit in Sekunden", "Antwort", null, PlotOrientation.VERTICAL, false,
			true, false);
	/**
