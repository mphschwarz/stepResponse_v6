...
import pro2e.teamX.matlabfunctions.FminSearch;
...
public class EinstellungenFminSearch extends JDialog implements ActionListener {
	...
	public FminSearch fminSearch = new FminSearch();
	...
	public EinstellungenFminSearch(JFrame frame, String title) {
		...
		add(Box.createVerticalGlue(), new GridBagConstraints(0, 4, 1, 1, 0.0, 1.0, GridBagConstraints.CENTER,
				GridBagConstraints.VERTICAL, new Insets(10, 10, 10, 10), 0, 0));

		add(btübernhemen, new GridBagConstraints(0, 5, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
				new Insets(10, 10, 10, 10), 0, 0));
		add(btabbrechen, new GridBagConstraints(1, 5, 1, 1, 1.0, 0.0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
				new Insets(10, 10, 10, 10), 0, 0));
