...
public class EingabePanel extends JPanel implements ActionListener {
      ...
      private String[] items = {"1. Ordnung", "2. Ordnung", "3. Ordnung", "4. Ordnung", "5. Ordnung", "6. Ordnung", "7. Ordnung", "8. Ordnung", "9. Ordnung", "10. Ordnung"};
      
      
  	  public JComboBox ordnungVon = new JComboBox(items);
//      public JComboBox ordnungBis = new JComboBox(items));
