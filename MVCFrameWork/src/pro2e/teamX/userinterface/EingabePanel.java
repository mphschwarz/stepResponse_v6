...
public class EingabePanel extends JPanel implements ActionListener {
      ...
      private JComboBox ordnungVon;
      private JComboBox ordnungBis;
      private String[] ordString = {"---", "1. Ordnung", "2. Ordnung", "3. Ordnung", "4. Ordnung", "5. Ordnung", "6. Ordnung", "7. Ordnung", "8. Ordnung", "9. Ordnung", "10. Ordnung"};
      ...
      public EingabePanel() {
            ...
            // JComboBox
            ordnungVon = new JComboBox(ordString);
            ordnungVon.setSelectedIndex(0);
            ordnungVon.setActionCommand("ordListVon");
            ordnungVon.addActionListener(this);

            ordnungBis = new JComboBox(ordString);
            ordnungBis.setSelectedIndex(0);
            ordnungBis.setActionCommand("ordListBis");
            ordnungBis.addActionListener(this);
  	...
  	public void actionPerformed(ActionEvent e) {
    	  if (e.getActionCommand().equals("ordListVon")) {
    		  int i = ordnungVon.getSelectedIndex();
    		  System.out.println("Ordnung von: " + i);
    	  }
    	  
    	  if (e.getActionCommand().equals("ordListBis")) {
    		  int i = ordnungBis.getSelectedIndex();
    		  System.out.println("Ordnung bis: " + i);
    	  }
