...
//
//public abstract class MatlabFunktionen3 {
...
//		double iy0 = 1.0;
//
//		while ((h[(int) ix5] < 0.5 && h[(int) (ix5 + 1)] > 0.5) == false) {
//			ix5 = ix5 + 1;
//		}
...
//			steps[i] = 0.008; //o.oo8 funkzioniert
//		}
...
//		SimplexOptimizer optimizer = new SimplexOptimizer(1e-13, 1e-16);//1e-6, 1e-12 //19.05 1e-13, 1e-16
...
//
//		try {
//			optimum = optimizer.optimize(new MaxEval(5000), new ObjectiveFunction(target), GoalType.MINIMIZE,
...
//		double[] butterini = butterIniC(1, 1, 10);
//		for (int i = 0; i < butterini.length; i++) {
//			System.out.println("Butter" + butterini[i]);
//		}
