 ...
 */
	public EinstellungenFminSearch(JFrame frame, String title) {
		...
		tfrelativerFehler.setRange(1e-25,0.1 );
		tfabsoluterFehler.setRange(1e-30,0.1);
		tfiterationen.setRange(10, 100000);
		tfschrittlaenge.setRange(1e-6, 1);
		tfStart.setRange(0, 400);
