...
public class TopView extends JPanel implements Observer, ActionListener {
	...
	public TopView(Controller controller) {
		...
		eingabePanel.btberechen.setEnabled(false);
		schrittantwortPlot
	...
	public void update(Observable obs, Object obj) {
		...
		eingabePanel.btberechen.setEnabled(true);
		filterPanel.rbSmoothingfilter.setEnabled(true);
		filterPanel.rbKeinfilter.setEnabled(true);
		repaint();
	}
