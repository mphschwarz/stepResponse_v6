...
public class EingabePanel extends JPanel implements ActionListener {
	...
	public JButton btberechen = new JButton("Optimierung starten");
	public JButton btAbbruch = new JButton("Abbrechen");

	public JComboBox jcordnungVon;
	public JComboBox jcordnungBis;
	public String[] jcordString = { "1. Ordnung", "2. Ordnung", "3. Ordnung", "4. Ordnung", "5. Ordnung", "6. Ordnung",
